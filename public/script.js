...
const renderLeetCodeStats = ({ username, solved, contestRating }) => `
  ...
  <div class="stat-grid" aria-label="LeetCode stats">
    <p><span class="stat-label">Solved:</span> <span class="stat-value">${solved.total}</span></p>
    <p><span class="stat-label">Easy:</span> <span class="stat-value">${solved.easy}</span></p>
    <p><span class="stat-label">Medium:</span> <span class="stat-value">${solved.medium}</span></p>
    <p><span class="stat-label">Hard:</span> <span class="stat-value">${solved.hard}</span></p>
    <p><span class="stat-label">Rating:</span> <span class="stat-value">${contestRating || "N/A"}</span></p>
  </div>
`;
